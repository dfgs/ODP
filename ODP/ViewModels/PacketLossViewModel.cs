...
namespace ODP.ViewModels
{
	public class PacketLossFilterViewModel : BaseFilterViewModel
	{
		...
		public static readonly DependencyProperty MaxValueProperty = DependencyProperty.Register("MaxValue", typeof(int), typeof(PacketLossFilterViewModel), new PropertyMetadata(0));
		public int MaxValue
		{
